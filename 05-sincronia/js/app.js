...
document.getElementById('btn-reintentos').addEventListener('click', () => fetchConReintentos('API'));
...
function detener() {
    // Verificar que haya un intervalo activo
    if (intervaloId) {
...
async function fetchConReintentos(nombre, intentos = 3) {
  ...
  for (let i = 0; i < intentos; i++) {
    try {
      ...
      // Backoff exponencial (si NO es el último intento)
      if (i < intentos - 1) {
